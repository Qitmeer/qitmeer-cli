...
var GetBlockCountCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		params := []interface{}{}
		blockCount, err := rpcClient.GetResString("getBlockCount", params)
		if err != nil {
			fmt.Println(err)
		} else {
...
var GetBlockTemplateCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		params := []interface{}{}
		blockCount, err := rpcClient.GetResString("getBlockTemplate", params)
		if err != nil {
			fmt.Println(err)
		} else {
			fmt.Println(blockCount)
...
var GetBlockHashCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		blockHash, err := rpcClient.GetResString("getBlockhash", params)
		if err != nil {
			fmt.Println(err)
		} else {
			// blockHash= " \"xxxx\" "
...
var GetBlockCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if len(args[0]) != 64 {
			...
			blockHash, err = rpcClient.GetResString("getBlockhash", []interface{}{blockNUmber})
			if err != nil {
				fmt.Println(err)
				return
			}
		...
		blockInfo, err = rpcClient.GetResString("getBlock", getBlockParam)
		if err != nil {
			fmt.Println(err)
		} else {
...
var GetMempoolCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		var blockInfo string
		blockInfo, err = rpcClient.GetResString("getMempool", getBlockParam)
		if err != nil {
			fmt.Println(err)
		} else {
			fmt.Println(blockInfo)
...
var GetRawTransactionCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		var txInfo string
		txInfo, err = rpcClient.GetResString("getRawTransaction", []interface{}{txHash, verbose})
		if err != nil {
			fmt.Println(err)
		} else {
			fmt.Println(txInfo)
...
var CreateRawTransactionCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		var rawTx string
		rawTx, err = rpcClient.GetResString("createRawTransaction", []interface{}{tx})
		if err != nil {
			fmt.Println(err)
		} else {
			fmt.Println(rawTx)
...
var DecodeRawTransactionCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		var err error
		var tx string
		tx, err = rpcClient.GetResString("decodeRawTransaction", []interface{}{args[0]})
		if err != nil {
			fmt.Println(err)
		} else {
			fmt.Println(tx)
...
var SendRawTransactionCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		var rs string
		rs, err = rpcClient.GetResString("sendRawTransaction", []interface{}{args[0], allowHighFee})
		if err != nil {
			fmt.Println(err)
		} else {
			fmt.Println(rs)
...
var TxSignCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		var err error
		var rs string
		rs, err = rpcClient.GetResString("txSign", []interface{}{args[0], args[1]})
		if err != nil {
			fmt.Println(err)
		} else {
			fmt.Println(rs)
...
var GetUtxoCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		tx, err = rpcClient.GetResString("getUtxo", params)
		if err != nil {
			fmt.Println(err)
		} else {
			fmt.Println(tx)
...
var GenerateCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		var rs string
		rs, err = rpcClient.GetResString("generate", params)
		if err != nil {
			fmt.Println(err)
		} else {
			fmt.Println(rs)
