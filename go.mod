module github.com/Qitmeer/qitmeer-cli

go 1.12

require (
	github.com/BurntSushi/toml v0.3.1
	github.com/qitmeer/qitmeer-cli v0.0.0-20190821095201-512931726507 // indirect
...
replace (
	...
	golang.org/x/sys v0.0.0-20190712062909-fae7ac547cb7 => github.com/golang/sys v0.0.0-20190712062909-fae7ac547cb7
